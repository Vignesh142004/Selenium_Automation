...
public class UserPasswordChange_Automation {
	...
	public static void main(String[] args) 
	{
		...
		select1.selectByVisibleText("Clients");
		
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("Vignesh@14");
		...
		driver.findElement(By.xpath("//input[@id='userNameId']")).sendKeys("VIGNESH@14");
